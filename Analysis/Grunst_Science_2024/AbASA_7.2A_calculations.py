########################################################
# AbASA_7.2A_calculations.py is a script that will 
# calculate AbASA values (7.2 Angstrom probe) from 
...
# using the command:
# >python AbASA_7.2A_calculations.py
#
# The following files will be generated:
#   AbASA_7.2A_single_trajectory.png
#   AbASA_7.2A_single_trajectory.svg
#   AbASA_7.2A_epitopes.svg
#   AbASA_7.2A_epitopes.svg
#   AbASA_7.2A_CV3-CC25_per_ensemble.png
#   AbASA_7.2A_CV3-CC25_per_ensemble.svg
#   AbASA_7.2A_woglycans_CV3-CC25_per_ensemble.png
#   AbASA_7.2A_woglycans_CV3-CC25_per_ensemble.svg
#   AbASA_7.2A_time_sampled_by_each_ensemble.png
#   AbASA_7.2A_time_sampled_by_each_ensemble.svg
#   AbASA_7.2A_times-summary.txt
#   These last three files are binary array files
#   AbASA_7.2A_step1data.pkl
#   AbASA_7.2A_step2data.pkl
#   AbASA_7.2A_step2pdata.pkl
#
# NOTE: This script is set to analyze every 20th simulated
# frame, whereas the manuscript reports analysis of every
# frame. To analyze every frame, set DOWNSAMPLE to 1.
# With DOWNSAMPLE=1, the script may take a long time 
# to completed. 
...
def plotSingleRun():
    ...
    sasa = md.shrake_rupley(trj_all,probe_radius=0.72,mode='residue')
    ...
    plt.xlabel('Time (us)')
    plt.savefig('AbASA_7.2A_epitopes.svg')
    plt.savefig('AbASA_7.2A_epitopes.png')
    ...
    plt.savefig('AbASA_7.2A_single_trajectory.png')
    plt.savefig('AbASA_7.2A_single_trajectory.svg')
...
def plotTimes():
    ...
    outFile = open('AbASA_7.2A_time-summary.txt', 'w')
    ...
    plt.tight_layout()
    plt.savefig('AbASA_7.2A_time_sampled_by_each_ensemble.png')
    plt.savefig('AbASA_7.2A_time_sampled_by_each_ensemble.svg')

def getSingleSASA(trj):
    sasa = md.shrake_rupley(trj,probe_radius=0.72,mode='residue')
    psasa=sasa[:,:1584].reshape((len(sasa),3,-1))
...
def doSASA():
    ...
    with open("AbASA_7.2A_step2data.pkl", "wb") as fp: 
        pickle.dump(dens_entries, fp)
    with open("AbASA_7.2A_step2pdata.pkl", "wb") as fp: 
    ...
    plt.tight_layout()
    plt.savefig('AbASA_7.2A_CV3-CC25_per_ensemble.png')
    plt.savefig('AbASA_7.2A_CV3-CC25_per_ensemble.svg')
    ...
    ax.set_ylabel('AbASA (nm^2)')
    plt.tight_layout()
    plt.savefig('AbASA_7.2A_woglycans_CV3-CC25_per_ensemble.png')
    plt.savefig('AbASA_7.2A_woglycans_CV3-CC25_per_ensemble.svg')
...
with open("AbASA_7.2A_step1data.pkl", "wb") as fp: 
    pickle.dump(outputs, fp)
#with open("AbASA_7.2A_step1data.pkl", "rb") as fp: 
