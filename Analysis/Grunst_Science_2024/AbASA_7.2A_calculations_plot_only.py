########################################################
# AbASA_7.2A_calculations_plot_only.py is a script that 
# will plot AbASA values (7.2 Angstrom probe) from 
...
# using the command:
# >python AbASA_7.2A_calculations_plot_only.py
#
# Note: it is assumed that you have already run:
#   AbASA_7.2A_calculations.py
#
...
#
  # read previous analysis
    with open("AbASA_7.2A_step2data.pkl", "rb") as fp:
        dens_entries=pickle.load(fp)
    with open("AbASA_7.2A_step2pdata.pkl", "rb") as fp:
