########################################################
# SASA_1.4A_calculations.py is a script that will 
# calculate SASA values from simulations of the Spike 
# protein.
#
...
# using the command:
# >python SASA_1.4A_calculations.py
#
# The following files will be generated:
#   SASA_single_trajectory.png
#   SASA_single_trajectory.svg
