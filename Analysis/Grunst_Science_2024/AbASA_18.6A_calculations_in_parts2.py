########################################################
# AbASA_18.6A_calculations_in_parts2.py is a script that 
# will calculate AbASA values (18.6 Angstrom probe) from 
...
# using the command:
# >python AbASA_18.6A_calculations_in_parts2.py
#
# NOTE: Before running this script, you must run:
#   AbASA_18.6A_calculations_in_parts1.py
#
...
# to distribute the calculation, this script will only run the part 2 calculations and each rank will analyze up to 80 trajectories.  
rank=int(sys.argv[1])
...
# Step 1 done already. Just going to do part 2
