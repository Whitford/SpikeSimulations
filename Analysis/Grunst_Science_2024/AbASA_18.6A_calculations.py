########################################################
# AbASA_18.6A_calculations.py is a script that will 
# calculate AbASA values (18.6 Angstrom probe) from 
...
# using the command:
# >python AbASA_18.6A_calculations.py
#
# The following files will be generated:
#   AbASA_18.6A_single_trajectory.png
#   AbASA_18.6A_single_trajectory.svg
...
#   These last three files are binary array files
#   AbASA_18.6A_step1data.pkl
#   AbASA_18.6A_step2data.pkl
#   AbASA_18.6A_step2pdata.pkl
#
# NOTE: This script is set to analyze every 20th simulated
# frame, whereas the manuscript reports analysis of every
# frame.  To analyze every frame, set DOWNSAMPLE=1 (below).
# With DOWNSAMPLE=1, the script may take a long time (>week)
# to completed. If you are interested in analyzing every
# frame, then try the AbASA_18.6A_calculations_in_part
# scripts, which allow for distributed computation.
#
########################################################
...
def doSASA():
    ...
    with open("AbASA_18.6A_step2data.pkl", "wb") as fp: 
        pickle.dump(dens_entries, fp)
    with open("AbASA_18.6A_step2pdata.pkl", "wb") as fp: 
...
# DEFINE INFORMATION ABOUT THE ET MAPS  

# dens_name is a list of codes for the different ET densities considered. In relation to Grunst et al, the naming is:
