...
void printInteractionParameters(gmx::TextWriter* writer, t_functype ftype, const t_iparams& iparams)
{
	...
	/* ADDED sigma parameter */
        case F_FBPOSRES:
            writer->writeLineFormatted(
                    "pos0=(%15.8e,%15.8e,%15.8e), geometry=%d, r=%15.8e, k=%15.8e, sigma=%15.8e, R=%15.8e",
                    iparams.fbposres.pos0[XX], iparams.fbposres.pos0[YY], iparams.fbposres.pos0[ZZ],
                    iparams.fbposres.geom, iparams.fbposres.r, iparams.fbposres.k, iparams.fbposres.sigma,
                    iparams.fbposres.RR);
            break;
        case F_RBDIHS:
